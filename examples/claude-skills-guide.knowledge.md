    ...
    [
      {
        ...
        "source": "s1",
        "locator": null,
        "label": "Building Skills for Claude — Complete Guide",
        "url": null
      }
    ]
...
### `skill__uses__yaml-frontmatter`

- Endpoints: `skill` → `yaml-frontmatter`
- Type: `uses`
- Weight: `1.0`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "A skill uses YAML frontmatter as its primary metadata and trigger mechanism"

### `skill__enables__progressive-disclosure`

- Endpoints: `skill` → `progressive-disclosure`
- Type: `enables`
- Weight: `1.0`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "The skill folder structure enables three-level progressive disclosure"

### `yaml-frontmatter__part-of__skill-description-field`

- Endpoints: `yaml-frontmatter` → `skill-description-field`
- Type: `part-of`
- Weight: `1.0`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "The description field is the most important part of YAML frontmatter"

### `skill-description-field__enables__testing-strategy`

- Endpoints: `skill-description-field` → `testing-strategy`
- Type: `enables`
- Weight: `0.8`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "The description field is what triggering tests validate"
...
**Label:**
    ...
    "Skills extend MCP by adding the workflow knowledge layer on top of connectivity"

### `skill-use-case-categories__based-on__use-case-definition`

- Endpoints: `skill-use-case-categories` → `use-case-definition`
- Type: `based-on`
- Weight: `0.8`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Use case categories provide the framework for concrete use case definition"

### `use-case-definition__enables__skill-description-field`

- Endpoints: `use-case-definition` → `skill-description-field`
- Type: `enables`
- Weight: `0.9`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "A well-defined use case directly informs the description field content"

### `testing-strategy__enables__skill-iteration`

- Endpoints: `testing-strategy` → `skill-iteration`
- Type: `enables`
- Weight: `1.0`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Testing surfaces the signals needed for iteration"

### `skill-iteration__extends__skill-description-field`

- Endpoints: `skill-iteration` → `skill-description-field`
- Type: `extends`
- Weight: `0.9`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Iteration typically requires refining the description field"

### `distribution-model__extends__open-standard-skills-api`

- Endpoints: `distribution-model` → `open-standard-skills-api`
- Type: `extends`
- Weight: `0.8`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "The API extends the manual distribution model for programmatic use"

### `workflow-patterns__uses__mcp`

- Endpoints: `workflow-patterns` → `mcp`
- Type: `uses`
- Weight: `0.9`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Most workflow patterns orchestrate MCP tool calls"

### `troubleshooting-reference__extends__skill-iteration`

- Endpoints: `troubleshooting-reference` → `skill-iteration`
- Type: `extends`
- Weight: `0.8`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Troubleshooting is the diagnostic phase of the iteration cycle"

### `progressive-disclosure__based-on__yaml-frontmatter`

- Endpoints: `progressive-disclosure` → `yaml-frontmatter`
- Type: `based-on`
- Weight: `1.0`
- Confidence: `high`
- Origin: `unspecified`
...
**Label:**
    ...
    "Level 1 of progressive disclosure is the YAML frontmatter"

### `skill-use-case-categories__enables__workflow-patterns`

- Endpoints: `skill-use-case-categories` → `workflow-patterns`
- Type: `enables`
- Weight: `0.8`
- Confidence: `medium`
- Origin: `unspecified`
...
**Label:**
    ...
    "The use case category determines which workflow pattern to apply"

### `open-standard-skills-api__based-on__mcp`

- Endpoints: `open-standard-skills-api` → `mcp`
- Type: `based-on`
- Weight: `0.7`
- Confidence: `medium`
- Origin: `unspecified`
...
**Label:**
    ...
    "Agent Skills open standard is designed analogously to MCP as a cross-platform primitive"



## Fakten & Daten

| ID | Fakt | Wert | Kontext | Zeitbezug | Raum | Konfidenz | Quelle | Origin | Evidence |
|----|------|------|---------|-----------|------|-----------|--------|--------|----------|
| f1 | Skill build time for first skill | 15-30 minutes | Using the skill-creator skill for an initial working skill | 2026-01 |  | medium | [1] |  |  |
| f2 | Description field maximum length | 1024 characters | YAML frontmatter description field constraint | 2026-01 |  | high | [1] |  |  |
| f3 | compatibility field maximum length | 500 characters | YAML frontmatter optional compatibility field | 2026-01 |  | high | [1] |  |  |
| f4 | SKILL.md recommended maximum size | 5,000 words | Above this limit, context performance degrades; move detailed docs to references/ | 2026-01 |  | medium | [1] |  |  |
| f5 | Simultaneous skills practical limit | 20-50 skills | Beyond this, context performance degrades; use selective enablement | 2026-01 |  | medium | [1] |  |  |
| f6 | Organization-level skills feature shipped | December 18, 2025 | Workspace-wide admin deployment with automatic updates | 2025-12-18 |  | high | [1] |  |  |
| f7 | Token consumption with skill (illustrative example) | 6,000 tokens (vs. 12,000 without skill) | Performance comparison example in guide; 50% reduction | 2026-01 |  | low | [1] |  |  |
| f8 | Message count with skill (illustrative example) | 2 messages (vs. 15 without skill) | Performance comparison example in guide; 87% reduction | 2026-01 |  | low | [1] |  |  |
| f9 | Skill triggering aspirational target | 90% on relevant queries | Aspirational benchmark, not a precise threshold; Anthropic developing better measurement tooling | 2026-01 |  | medium | [1] |  |  |
| f10 | Skills API endpoint | /v1/skills | For listing and managing skills programmatically; requires Code Execution Tool beta | 2026-01 |  | high | [1] |  |  |
| f11 | API parameter for adding skills to requests | container.skills | Used in Messages API requests to include skills | 2026-01 |  | high | [1] |  |  |
| f12 | Public skills repository | github.com/anthropics/skills | Anthropic-created reference skills available for customization | 2026-01 |  | high | [1] |  |  |
| f13 | Partner skills directory examples | Asana, Atlassian, Canva, Figma, Sentry, Zapier | Partners with skills in the directory as of guide publication | 2026-01 |  | high | [1] |  |  |
...
- Origin: `unspecified`
- Evidence: —
- Include in default retrieval: `true`
...
- Kind: `source_claims`
- Concepts: `skill-use-case-categories`
- Temporal scope: "2026"
- Token estimate: 289
- Origin: `unspecified`
- Evidence: —
...
- Kind: `source_claims`
- Concepts: `skill-description-field`
- Temporal scope: "2026"
- Token estimate: 247
- Origin: `unspecified`
- Evidence: —
...
- Kind: `source_claims`
- Concepts: `open-standard-skills-api`
- Temporal scope: "2026"
- Token estimate: 218
- Origin: `unspecified`
- Evidence: —
...
### [1] building-skills-for-claude.pdf
